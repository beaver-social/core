    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-xs md:text-sm text-muted-foreground mt-1">Connect your Sui wallet to interact with the Beaver Social platform.</p>
            </div>
                ...
                >
                    <div className="p-4 md:p-6 bg-grey-800/30 border border-grey-800 rounded-md">
                        <div className="flex gap-2 items-center">
                            <Icon name="CircleCheck" className="h-3.5 w-3.5 md:h-4 md:w-4 text-green-600" /><h3 className="text-base md:text-lg font-medium text-green-700"> Connected</h3>
                        </div>
                    </div>
