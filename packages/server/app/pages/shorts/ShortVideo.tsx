                ...
                <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Button variant="outline" className="text-sm text-white">Follow</Button>
                        </div>
                    </div>

                    <p className="text-white/90 text-sm mt-1">{truncateText(caption, 50)} <span className="text-white/50 cursor-pointer hover:opacity-80 transition-opacity">more</span></p>
                </div>
            </div>
