  ...
  return (
    <div className="flex items-center justify-between">
      ...
      >
        ...
        <span
          className={`text-sm font-medium ${userPostInteraction?.hasLiked ? "text-like" : "text-muted-foreground"} transition-colors`}
        >
          {props.analytics?.likes}
        </span>
      </motion.button>
      ...
      >
        ...
        <span className="text-sm font-medium group-hover:text-comment transition-colors">
          {props.analytics?.comments}
        </span>
      </motion.button>
      ...
      >
        ...
        <span className="text-sm font-medium group-hover:text-repost transition-colors">
          {props.analytics?.reposts}
        </span>
      </motion.button>
      ...
      >
        ...
        <span className="text-sm font-medium group-hover:text-share transition-colors">
          {props.analytics?.shares}
        </span>
      </motion.button>
    </div>
  );
