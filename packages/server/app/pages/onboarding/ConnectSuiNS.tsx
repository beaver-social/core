...
export default function ConnectSuiNS({
  onComplete,
  handleBack,
  handleSkip,
}: Props) {
    ...
    <div className="flex flex-col items-center text-center space-y-8">
      ...
      >
        ...
        <p className="text-muted-foreground mb-6 max-w-md mx-auto">
          SuiNS is a decentralized naming service for the Sui network. Link your
          SuiNS name to your profile for easier discovery.
        </p>
      </motion.div>
                  ...
                  <div className="space-y-2 max-h-60 overflow-y-auto">
                    ...
                    {searchResults.map((result, index) => (
                      <motion.div
                        ...
                        onClick={() =>
                          result.isAvailable && setSelectedName(result.name)
                        }
                      >
                ...
                {!isSearching && searchTerm && searchResults.length === 0 && (
                  <div className="py-6 text-center">
                    <p className="text-muted-foreground">
                      No SuiNS names found. Try a different search.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col items-center py-4">
                  <div className="size-16 rounded-full bg-primary/10 flex items-center justify-center mb-4">
                    ...
                    >
                      <path
                        d="M16 8V5C16 4.73478 15.8946 4.48043 15.7071 4.29289C15.5196 4.10536 15.2652 4 15 4H5C4.73478 4 4.48043 4.10536 4.29289 4.29289C4.10536 4.48043 4 4.73478 4 5V19C4 19.2652 4.10536 19.5196 4.29289 19.7071C4.48043 19.8946 4.73478 20 5 20H15C15.2652 20 15.5196 19.8946 15.7071 19.7071C15.8946 19.5196 16 19.2652 16 19V16"
                        stroke="currentColor"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <p className="text-sm text-muted-foreground mb-6">
                    Connect this SuiNS name to your profile
                  </p>
            ...
            {isConnected && (
              <div className="py-8 flex flex-col items-center">
                ...
                <p className="text-muted-foreground mb-2">
                  {selectedName} is now linked to your profile
                </p>
              </div>
            )}
