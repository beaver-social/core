    ...
    <div className="flex flex-col items-center text-center space-y-8">
      ...
      >
        ...
        <p className="text-muted-foreground mb-6 max-w-md mx-auto">
          Your decentralized identity will be created by signing a message with
          your wallet. This doesn't cost any gas and securely links your wallet
          to your new DID.
        </p>
      </motion.div>
          ...
          <CardContent className="p-6">
            <div className="flex flex-col items-center space-y-6">
              <div className="text-left w-full space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  <div
                    className={`rounded-full mt-0.5 ${isCreating || isComplete ? "bg-primary/10 text-primary" : "bg-muted text-muted-foreground"}`}
                  >
                    <svg
                      width="36"
                      height="36"
                  ...
                  <div className="flex-1">
                    <p
                      className={`text-sm ${isCreating || isComplete ? "text-foreground" : "text-muted-foreground"}`}
                    >
                ...
                <div className="flex items-center space-x-3">
                  <div
                    className={`rounded-full mt-0.5 ${isComplete ? "bg-primary/10 text-primary" : "bg-muted text-muted-foreground"}`}
                  >
                    <svg
                      width="36"
                      height="36"
