      ...
      >
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1 text-left">
            ...
            <p className="text-sm text-muted-foreground">
              Your identity belongs to you, not controlled by any corporation or
              government.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1 text-left">
            ...
            <p className="text-sm text-muted-foreground">
              You control who can access your data and how they can use it.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1 text-left">
            ...
            <p className="text-sm text-muted-foreground">
              Share only the information you want without exposing all your
              personal details.
            </p>
          </div>
        </div>
