        ...
        <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                            Control who can see your content and who can tag you in posts and comments.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                    Choose who can see your posts by default. You can still change this for individual posts.
                </p>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-md hover:bg-secondary/50">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Anyone on or off the platform</p>
                            </div>
                        </div>
                        <input
                            type="radio"
                    ...
                    <div className="flex items-center justify-between p-3 rounded-md hover:bg-secondary/50">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Only people who follow you</p>
                            </div>
                        </div>
                        <input
                            type="radio"
                    ...
                    <div className="flex items-center justify-between p-3 rounded-md hover:bg-secondary/50">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Only holders of your creator token</p>
                            </div>
                        </div>
                        <input
                            type="radio"
                    ...
                    <div className="flex items-center justify-between p-3 rounded-md hover:bg-secondary/50">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Any user can tag you</p>
                            </div>
                        </div>
                        <input
                            type="radio"
                    ...
                    <div className="flex items-center justify-between p-3 rounded-md hover:bg-secondary/50">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Only people you follow can tag you</p>
                            </div>
                        </div>
                        <input
                            type="radio"
                    ...
                    <div className="flex items-center justify-between p-3 rounded-md hover:bg-secondary/50">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Only verified web3 identities can tag you</p>
                            </div>
                        </div>
                        <input
                            type="radio"
        ...
        <div className="space-y-6">
            <div className="bg-card rounded-lg p-6 border">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                            Control the visibility of your posts and interactions on the platform.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="space-y-6">
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Allow your posts to be visible in public feeds and search results
                            </p>
                        </div>
                        <Switch
                            id="posts-visible"
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <Label htmlFor="comments-visible">Allow Comments on My Posts</Label>
                            <p className="text-sm text-muted-foreground">
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <div className="space-y-6">
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <Label htmlFor="search-engines">Allow Search Engine Indexing</Label>
                            <p className="text-sm text-muted-foreground">
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                    Blocked accounts cannot follow you, view your posts, or interact with you.
                </p>
                            ...
                            <div key={account.id} className="flex items-center justify-between p-3 border rounded-md">
                                <div className="flex items-center gap-3">
                                    <div className="h-10 w-10 rounded-full bg-secondary flex items-center justify-center">
                                        <Icon name={account.avatar as any} className="h-5 w-5 text-muted-foreground" />
                                    </div>
                                    <div>
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                    You won't see posts from muted accounts in your feed, but they can still interact with you.
                </p>
                    ...
                    <div className="space-y-3 mt-2">
                        {mutedAccounts.map(account => (
                            <div key={account.id} className="flex items-center justify-between p-3 border rounded-md">
                                ...
                                <Button variant="ghost" size="sm">Unmute</Button>
                            </div>
                        ))}
                    </div>
                ) : (
        ...
        <div className="space-y-6">
            <div className="bg-card rounded-lg p-6 border">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                            Control who can send you direct messages and manage your messaging privacy.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <div className="space-y-3 mt-4">
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <Label htmlFor="allow-everyone">Allow Messages from Everyone</Label>
                            <p className="text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <Label htmlFor="allow-followers">Allow Messages from Followers</Label>
                            <p className="text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <Label htmlFor="allow-verified">Allow Messages from Verified Identities</Label>
                            <p className="text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center justify-between p-3 rounded-md hover:bg-secondary/50">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Display city and country</p>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-md hover:bg-secondary/50">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Display only your country</p>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-md hover:bg-secondary/50">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Don't show any location information</p>
                            </div>
                        </div>
                        <input type="radio" name="profile-location" />
                    </div>
        ...
        <div className="space-y-6">
            <div className="bg-card rounded-lg p-6 border">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                            Control how your personal data is shared with partners and third parties.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <div className="mt-6 p-4 border rounded-md bg-secondary/20">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                        Your on-chain activity is public by default on the blockchain. These settings only control how our platform uses and shares this data with third parties.
                    </p>
                </div>
        ...
        <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <div className="space-y-6 mt-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Store data on decentralized networks instead of centralized servers
                            </p>
                        </div>
                ...
                <div className="mt-6 p-4 border rounded-md bg-primary/5">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                        Your data is encrypted with keys that only you control. Make sure to back up your keys securely.
                    </p>
                    <div className="mt-4 flex gap-2">
                        <Button variant="outline" size="sm">Backup Keys</Button>
                        <Button variant="ghost" size="sm">Rotate Keys</Button>
                    </div>
                </div>
            </div>
