    ...
    <>
      ...
      <div className="bg-card rounded-lg p-6 border space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          Your username is unique and appears in your profile URL. It can
          contain only letters, numbers, and underscores, with no spaces.
        </p>
        <div className="flex flex-col space-y-3">
      ...
      <div className="bg-card rounded-lg p-6 border space-y-4">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <Input id="email" placeholder="yourname@example.com" />
        </div>
      ...
      <div className="bg-card rounded-lg p-6 border space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          Your phone number is used for authentication and notifications. You
          can add multiple phone numbers.
        </p>
        <div className="flex flex-col space-y-3">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Verification helps users know they're interacting with authentic
              accounts.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Your identity is securely managed on the SUI blockchain. This
              identity is unique and represents your account.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-6">
      <div className="bg-card rounded-lg p-6 border">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Your account identity is represented as an NFT on the SUI
              blockchain and can be transferred to another wallet. This action
              is permanent and will give full control of your account to the new
              owner.
            </p>
            <div className="mt-4 p-3 bg-amber-500/10 rounded-md text-sm">
              <div className="flex items-start">
                ...
                <p className="text-amber-700 dark:text-amber-400">
                  Transferring your identity will permanently move your account
                  to a new owner. This includes your profile, followers, posts,
                  and all other account data.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-card rounded-lg p-6 border space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div className="pt-2">
            <Button variant="destructive">Initiate Transfer</Button>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-6">
      <div className="bg-card rounded-lg p-6 border">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              zkLogin allows you to securely authenticate with your existing
              accounts while maintaining privacy through zero-knowledge proofs.
              Set up zkLogin to enable passwordless authentication with your
      ...
      {isSetup ? (
        ...
        <div className="bg-card rounded-lg p-6 border space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Choose an authentication provider to set up zkLogin for your
            account.
          </p>
          ...
          <div className="pt-4">
            <p className="text-xs text-muted-foreground">
              By enabling zkLogin, you're creating a secure connection between
              your social account and your on-chain identity without revealing
              sensitive information on the blockchain.
            </p>
          </div>
        </div>
      )}
  ...
  return (
    <div className="space-y-6">
      <div className="bg-card rounded-lg p-6 border">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Set up recovery methods to regain access to your web3 identity if
              you lose access to your primary authentication method.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card rounded-lg p-6 border space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          Generate a set of one-time use recovery keys that can be used to
        ...
        <div className="space-y-4">
          <div className="p-4 border rounded-md bg-secondary/20">
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Your recovery keys are securely encrypted. Each key can only be
              used once.
            </p>
  ...
  return (
    <div className="space-y-6">
      <div className="bg-card rounded-lg p-6 border">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Manage which applications and services have access to your web3
              identity and what actions they can perform.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card rounded-lg p-6 border space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          Set default permission levels for new applications requesting access
          to your identity.
        </p>
          ...
          <div className="flex justify-between items-center p-3 border rounded-md">
            <div>
              <span className="font-medium">
                Require Authentication for Transfers
              </span>
              <p className="text-xs text-muted-foreground mt-1">
