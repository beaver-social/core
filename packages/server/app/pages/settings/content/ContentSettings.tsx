    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                    Select languages for content you'd like to see. Content in these languages will be prioritized in your feed.
                </p>
        ...
        <div className="space-y-6">
            <div className="bg-card rounded-lg p-6 border">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                            Control how sensitive or potentially disturbing content is displayed.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <div className="space-y-6">
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <Label htmlFor="sensitive-images">Hide Sensitive Images and Videos</Label>
                            <p className="text-sm text-muted-foreground">
...
export function InterestsContent() {
    const selectedInterests = [
        "Blockchain", "NFTs", "DeFi", "Web3", "Cryptocurrency"
    ];

    const recommendedInterests = [
        "DAOs", "Metaverse", "Gaming", "AI", "Digital Art", "Smart Contracts"
    ];
        ...
        <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                    {selectedInterests.map(interest => (
                        <div key={interest} className="px-3 py-1.5 bg-secondary rounded-full flex items-center gap-1.5">
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                    {recommendedInterests.map(interest => (
                        <div key={interest} className="px-3 py-1.5 border rounded-full flex items-center gap-1.5">
                            <span className="text-sm font-medium">{interest}</span>
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <div className="space-y-6">
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <Label htmlFor="auto-interests">Automatic Interest Detection</Label>
                            <p className="text-sm text-muted-foreground">
        ...
        <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <Label htmlFor="autoplay-mobile">Autoplay Media on Mobile Data</Label>
                            <p className="text-sm text-muted-foreground">
            ...
            <div className="bg-card rounded-lg p-6 border space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                    <div className="border rounded-md p-4 flex flex-col items-center text-center cursor-pointer hover:bg-secondary/20">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">Standard feed view</p>
                    </div>
                    ...
                    <div className="border rounded-md p-4 flex flex-col items-center text-center cursor-pointer hover:bg-secondary/20 bg-primary/5">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">More content per screen</p>
                    </div>
                </div>
            </div>
