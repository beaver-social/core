        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Manage the wallets connected to your account. These wallets can be
              used for transactions, NFT management, and identity operations.
            </p>
          </div>
        </div>
      </div>
        ...
        {view === "grid" ? (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div
                key={item}
                className="rounded-lg border overflow-hidden bg-secondary/30"
              >
