    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <p className="text-zinc-400">
            Native integration with Sui, Ethereum, Solana, and other popular
            blockchain networks.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-zinc-400">
            Comprehensive SDKs for React, Node.js, Flutter, and more with
        ...
        >
          ...
          <p className="text-zinc-400">
            RESTful and GraphQL APIs for seamless integration with your existing
            infrastructure.
          </p>
        </motion.div>
      </div>
