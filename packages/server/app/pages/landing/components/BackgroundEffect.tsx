  ...
  return (
    <div className="relative">
      ...
      <div className="hidden">
        ...
        <div className="absolute -top-96 left-1/4 h-[600px] w-[600px] rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 opacity-[0.07] blur-3xl" />

        <div className="absolute -bottom-32 right-1/4 h-[500px] w-[500px] rounded-full bg-gradient-to-r from-blue-400 via-cyan-500 to-teal-400 opacity-[0.07] blur-3xl" />

        <div className="absolute top-1/3 -right-32 h-[400px] w-[400px] rounded-full bg-gradient-to-r from-orange-400 via-rose-400 to-red-500 opacity-[0.07] blur-3xl" />
      </div>
    </div>
  );
}
