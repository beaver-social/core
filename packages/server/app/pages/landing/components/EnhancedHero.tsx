...
function YourSocialApp () {
  ...
  // implement login button
    ...
    const prevSnippet = () => {
        setActiveSnippet((prev) => (prev - 1 + codeSnippets.length) % codeSnippets.length);
    };
            ...
            return (
                <code className="language-javascript text-zinc-300">
                    ...
                    >
                        ...
                        <span className="text-orange-300">  debug: false</span><br />
                        <span className="text-orange-300">  network: "mainnet"</span><br />
                        <span className="text-orange-300">  apiBaseUrl: "https://api.beaver.social"</span><br />
                        <span className="text-orange-300">  zkLoginWallets: </span>
                        <span className="text-purple-500">{"{"}</span><br />
                        <span className="text-orange-300">    enabled: true</span><br />
                        <span className="text-purple-500">{"  }"}</span><br />
        ...
        >
            <div className="mb-2 flex items-center justify-between">
                <div className="flex items-center gap-1">
                    ...
                    <div className="ml-2 text-xs text-zinc-500">{codeSnippets[activeSnippet].title}</div>
                </div>
                <button
                    onClick={handleCopy}
