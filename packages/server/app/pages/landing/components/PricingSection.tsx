        ...
        <section id="pricing" className="container mx-auto py-20">
            <div className="mb-12 flex flex-col items-center justify-center">
                <h2 className="text-center text-3xl font-light leading-tight md:text-4xl">
                    Flexible <span className="font-medium text-primary">pricing</span> for teams of all sizes
                </h2>
                <p className="mt-4 max-w-2xl text-center text-muted-foreground">
                    From indie developers to enterprise teams, we have a plan that works for you
                </p>
            </div>
        ...
        <Card className={
            ...
            <CardHeader>
                ...
                <div className="mt-4 flex items-baseline">
                    ...
                    {!hidePerMonth && <span className="ml-1 text-muted-foreground">/month</span>}
                </div>
            </CardHeader>
            <CardContent>
