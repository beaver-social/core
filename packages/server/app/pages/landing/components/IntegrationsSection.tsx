      ...
      <div className="grid gap-12 md:grid-cols-2">
        <div className="flex flex-col justify-center">
          <h2 className="text-3xl font-light leading-tight md:text-4xl">
            Seamless{" "}
            <span className="font-medium text-primary">integrations</span> with
            your tech stack
          </h2>
          <p className="mt-4 text-muted-foreground">
            Beaver Social works with your existing infrastructure and favorite
            tools. Our SDK is designed to integrate with minimal friction.
          </p>
          <ul className="mt-6 space-y-2">
            <IntegrationListItem>
              React, Next.js, Angular, Vue and more
            </IntegrationListItem>
            <IntegrationListItem>
              Multiple blockchain networks
            </IntegrationListItem>
            <IntegrationListItem>
              Compatible with popular wallet providers
            </IntegrationListItem>
            <IntegrationListItem>
