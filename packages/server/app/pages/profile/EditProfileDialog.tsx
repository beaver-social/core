...
const formSchema = z.object({
    ...
    about: z.string().max(160, "Bio must be less than 160 characters").nullable().optional(),
...
export default function EditProfileDialog({ isOpen, onClose, initialValues }: Props) {
    ...
    const handleImageCrop = (croppedFile: File, aspectRatio: 'square' | 'portrait' | 'landscape' | 'banner' | 'wide' | 'custom') => {
    ...
    const handleBannerCrop = (croppedFile: File, aspectRatio: 'square' | 'portrait' | 'landscape' | 'banner' | 'wide' | 'custom') => {
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <div className="relative">
                                                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                        <Icon name="Twitter" className="size-4 text-muted-foreground" />
                                                    </div>
                                                    <Input
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <div className="relative">
                                                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                        <Icon name="Instagram" className="size-4 text-muted-foreground" />
                                                    </div>
                                                    <Input
                                                        placeholder="username"
                                                        className="pl-10"
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <div className="relative">
                                                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                        <Icon name="Youtube" className="size-4 text-muted-foreground" />
                                                    </div>
                                                    <Input
                                                        placeholder="channel"
                                                        className="pl-10"
