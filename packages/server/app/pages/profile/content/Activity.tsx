...
const activities: ActivityItem[] = [
  {
    ...
    targetPost: {
      id: "123",
      content:
        "Web3 is revolutionizing the way we interact with the internet! #blockchain #decentralization",
      author: {
        name: "Alex Thompson",
        handle: "alexthompson",
      },
  ...
  },
  {
    ...
    content:
      "Great analysis! I think DAOs are going to transform organizational structures in the next decade.",
    targetPost: {
      id: "789",
      content:
        "My thoughts on the future of DAOs and decentralized governance structures...",
      author: {
  ...
  },
  {
    ...
    targetPost: {
      id: "101112",
      content:
        "Thanks to @ishtails for the insightful feedback on our new protocol design!",
      author: {
        name: "DeFi Protocol",
        handle: "defiprotocol",
      },
    ...
    return (
      <div className="p-10 text-center">
        ...
        <p className="text-grey-500 mt-2">
          When this user likes or comments on posts, you'll see their activity
          here.
        </p>
      </div>
    );
      ...
      case "mention":
        return (
          <span>
            ...
            {" mentioned you in a "}
            <Link
              to={`/post/${activity.targetPost?.id}`}
              className="hover:underline"
            >
              post
            </Link>
      ...
      case "nft":
        return (
          <span>
            ...
            {" minted NFT "}
            <Link
              to={`/nft/${activity.nftData?.collectionName}/${activity.nftData?.tokenId}`}
              className="hover:underline"
            >
              {activity.nftData?.collectionName} {activity.nftData?.tokenId}
            </Link>
          </span>
        );
      default:
